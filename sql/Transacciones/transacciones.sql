...
BEGIN
    ...
    BEGIN
        ...
        SELECT COALESCE(MAX(id_pago), 0) + 1 INTO v_nuevo_id FROM "Pago";

        -- Registrar el pago
        INSERT INTO "Pago" (id_pago, fecha_pago, monto, metodo_pago, estado, id_alquiler)
        VALUES (v_nuevo_id, CURRENT_DATE, p_monto, p_metodo_pago, 'Completado', p_id_alquiler);
